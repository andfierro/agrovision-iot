      ...
      <header className="bg-white px-6 pt-12 pb-4 shadow-sm z-10 sticky top-0">
        <div className="flex justify-between items-start">
          ...
          >
             ...
             <span>{checkingModel ? 'CARGANDO...' : (modelReady ? 'MODELO LOCAL' : 'ERROR DE CARGA')}</span>
          </button>
        </div>
      </header>
      ...
      <main className="flex-1 p-6 overflow-y-auto">
            ...
            <div className="flex-1 flex flex-col justify-center items-center gap-6 my-4">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500 mt-2 px-4 text-sm">
                  Análisis mediante Red Neuronal (CNN) ejecutada en el dispositivo + Fusión de Sensores.
                </p>
              </div>
            </div>
        ...
        {image && isAnalyzing && (
          <div className="flex flex-col items-center justify-center h-full space-y-6 animate-pulse">
            ...
            <div className="text-center">
              <h3 className="text-xl font-bold text-gray-800">Procesando en Dispositivo</h3>
              <p className="text-sm text-gray-500 mt-1">
                Extrayendo características con TensorFlow.js...
              </p>
            </div>
          </div>
        )}
